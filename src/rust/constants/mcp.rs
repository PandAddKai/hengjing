...
/// 且慢工具标识符
pub const TOOL_QIEMAN: &str = "qieman";
...
/// 默认启用的工具列表
pub const DEFAULT_ENABLED_TOOLS: &[&str] = &[TOOL_QIEMAN, TOOL_JI, TOOL_SOU];
...
impl Default for McpConfig {
    fn default() -> Self {
        Self {
            tools: vec![
                McpToolConfig::new(TOOL_QIEMAN, true, false), // 且慢工具不可禁用
...
pub fn is_valid_tool_id(tool_id: &str) -> bool {
    matches!(tool_id, TOOL_QIEMAN | TOOL_JI | TOOL_SOU)
}
